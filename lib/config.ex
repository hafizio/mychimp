defmodule Mychimp.Config do
  ...
  defp get_api_key_from_config do
    sanitize_api_key(Application.get_env(:mychimp, :apikey)) || sanitize_api_key(Application.get_env(:mychimp, :api_key))
  end

  defp get_api_version_from_config do
    Application.get_env(:mychimp, :api_version) || "3.0"
  end
  ...
  defp get_shard(api_key) do
    ...
    case shard do
      nil ->
        Logger.error "[mailchimp] Not a valid api key"
